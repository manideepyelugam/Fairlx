...
const COLLECTION_ID = process.env.NEXT_PUBLIC_APPWRITE_PROJECT_TEAMS_ID || 'project_teams';
const COLLECTION_NAME = 'Project Teams';

export async function setupProjectTeams(databases: Databases, databaseId: string): Promise<void> {
