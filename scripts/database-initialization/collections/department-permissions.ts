...
const COLLECTION_ID = process.env.NEXT_PUBLIC_APPWRITE_DEPARTMENT_PERMISSIONS_ID || 'department_permissions';
const COLLECTION_NAME = 'Department Permissions';

export async function setupDepartmentPermissions(databases: Databases, databaseId: string): Promise<void> {
