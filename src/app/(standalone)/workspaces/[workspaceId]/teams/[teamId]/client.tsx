...
import { Users, Settings, Activity, LayoutDashboard, Shield, UserPlus, MoreVertical, Crown, Trash2, ArrowLeft } from "lucide-react";
    ...
    <div className="w-full flex flex-col gap-y-6">
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-start gap-4">
          <Avatar className="size-20 rounded-xl border-2">
            {team.imageUrl ? (
        ...
        <TabsContent value="overview" className="space-y-4 mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Latest updates and changes in the team
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="activity" className="space-y-4 mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Detailed history of team activities
              </CardDescription>
            </CardHeader>
            <CardContent>
